...
### Info
Currently, queries are run directly on .parquet files rather than DuckDB native databases.  .parquet files take up less space, but may have worse performance in some advanced operations.
